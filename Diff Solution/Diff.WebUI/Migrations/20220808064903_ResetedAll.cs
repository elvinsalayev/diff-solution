...
{
    public partial class ResetedAll : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogPostTagClouds", x => new { x.BlogPostId, x.PostTagId });
                    table.ForeignKey(
                        name: "FK_BlogPostTagClouds_Blogposts_BlogPostId",
                        column: x => x.BlogPostId,
                        principalTable: "Blogposts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogPostTagClouds_PostTags_PostTagId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPricing", x => new { x.ProductId, x.ProductColorId, x.ProductSizeId });
                    table.ForeignKey(
                        name: "FK_ProductPricing_ProductColors_ProductColorId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductPricing_ProductSizes_ProductSizeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogPostTagClouds_PostTagId",
                table: "BlogPostTagClouds",
                column: "PostTagId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPricing_ProductColorId",
                table: "ProductPricing",
                column: "ProductColorId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductPricing_ProductSizeId",
                table: "ProductPricing",
